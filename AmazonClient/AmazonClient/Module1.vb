...
Module Module1
    ...
    Sub Main()
        ...
        Dim strWhatToTest As String = "AMAZON" ' "UNIVCHICAGO"  ' "NEW_AMAZON"  '  "KLATENCOR"  '   "AMAZON"   ' "NEW_AMAZON"  '    "CYTECMXM" 
            ...
            If Not (m_vendorConfig Is Nothing) Then
                ...
                If m_vendorConfig.ToIdentity.Id.Length > 0 And _
                   m_vendorConfig.VendorPunchoutSetupURL.Length > 0 Then
                    ...
                    Dim strListOrders As String = "select distinct po_id from SYSADM8.PS_ISA_PO_DISP_XML"
