...
Public Class punchoutVendorConfig
    ...
    Private m_groupId As String = punchoutVendorConfig.CONFIG_GROUP_ID_DEFAULT
    ...
    Public Shared Function GetVendorConfig(ByVal vendorId As String, Optional ByVal groupId As String = punchoutVendorConfig.CONFIG_GROUP_ID_DEFAULT) As punchoutVendorConfig
        ...
        If vendorId.Length > 0 Then
            Try
                ...
                If groupId.Length > 0 Then
                    If groupId.ToUpper <> punchoutVendorConfig.CONFIG_GROUP_ID_DEFAULT.ToUpper Then
                    ...
                    If nodeCatalogs.ChildNodes.Count > 0 Then
                        For Each vendorCfg As XmlNode In nodeCatalogs.ChildNodes
                            If vendorCfg.NodeType = XmlNodeType.Element And vendorCfg.Name = "Catalog" Then
                                ...
                                sId = ""
                                sGrp = punchoutVendorConfig.CONFIG_GROUP_ID_DEFAULT
                                Try
                                ...
                                If (sId.Trim.ToUpper & "." & sGrp.Trim.ToUpper) = (vendorConfig.Id.ToUpper & "." & vendorConfig.GroupId.ToUpper) Then
                                    ...
                                    End Try
                                    Try
                                        sVal = vendorCfg.Attributes(name:="securityProtocol").Value
                                        If sVal.Trim.Length > 0 Then
                                            vendorConfig.SecurityProtocol = CType(sVal, SecurityProtocolType)
                                        End If
                                    Catch ex As Exception
                                    End Try
