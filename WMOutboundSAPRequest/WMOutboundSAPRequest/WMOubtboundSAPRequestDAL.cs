...
namespace WMOutboundSAPRequest
{
    class WMOubtboundSAPRequestDAL
    {
        ...
        /// </summary>
        /// <returns></returns>
        public int UpdateWMOutboundSAPRequestData(Logger m_oLogger, string ProcFlag)
        {
            ...
            try
            {
                ...
                strSQLstring = "UPDATE sysadm8.ps_nlnk2_req_out SET PROCESS_FLAG='" + ProcFlag + "', DATE_PROCESSED = SYSDATE WHERE PROCESS_FLAG = 'N' AND CUST_ID = 'SOLVAY'";
