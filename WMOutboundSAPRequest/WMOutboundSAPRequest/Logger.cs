...
public void SendEmailAlert(string sLastErrorMessage)
{
    try
    {
        ...
        string cErrMsg = testOrProd + "Utility WMOutboundSAPRequest had a critical error";
        string strBodyhead = "";
        string strbodydetl = "";
        string strBody = "";
         sdixaws2016test.EmailServices SDIEmailService = new sdixaws2016test.EmailServices();
          //WMOutboundSAPRequest.sdixaws2016test.EmailServices SDIEmailService = new WMOutboundSAPRequest.sdixaws2016test.EmailServices();
        ...
        strBody = strBodyhead + strbodydetl;
                try
                {
                    SDIEmailService.EmailUtilityServices("Mail", "SDIExchADMIN@sdi.com", "webdev@sdi.com; Donna.Ciampoli@sdi.com; scott.doyle@sdi.com; avacorp@sdi.com", testOrProd + "Error from WMOutboundSAPRequest Utility", "", "", strBody, "SDIERRMAIL", MailAttachmentName, MailAttachmentbytes.ToArray());
                }
                catch (Exception ex1)
                {
                }
