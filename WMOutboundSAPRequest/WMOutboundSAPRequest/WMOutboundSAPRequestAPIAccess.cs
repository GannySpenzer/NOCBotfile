            ...
            try
            {
                ...
                if (dtResponse.Rows.Count != 0)
                {
                    ...
                    for (int i = 0; i <= dtResponse.Rows.Count - 1; i++)
                    {
                        ...
                        List<WMOutboundSAPRequestBO> target = dtResponse2.AsEnumerable()
                        ...
                        using (var client = new WebClient())
                        {
                            ...
                            catch (Exception ex)
                            {
                                ...
                                m_oLogger.LogMessage("postWMOutboundSAPRequestData", "Authenication failed " + ex.Message);
                            }
                            ...
                            if (strResponse.ToUpper() != " ")
                            {
                                ...
                                objWMOubtboundSAPRequestDAL.UpdateWMOutboundSAPRequestData(m_oLogger, processFlag, ISA_IDENTIFIER);
                            }
                            else
                            {
