    ...
    Public Sub SendMailToApprover()
        Try
            ...
            For Each row As DataRow In dt.Rows
                ...
                ApprOrd.SendMail(StrBu, StrOrderNo, StrUserID)
            Next
...
Public Class ApprovalOrders
    ...
    Public Shared Function GetQuotedOrders() As DataTable
        ...
        Try
            Dim StrQry As String = "SELECT DISTINCT ORDER_NO,BUSINESS_UNIT_OM,ISA_EMPLOYEE_ID FROM PS_ISA_ORD_INTF_LN WHERE ISA_LINE_STATUS = 'QTW'  AND INV_ITEM_ID=' ' AND OPRID_APPROVED_BY = ISA_EMPLOYEE_ID "
        ...
        End Try
    End Function
    Public Sub SendMail(ByVal BU As String, ByVal OrderNo As String, ByVal EnterBY As String)
        Try
                ...
                ElseIf oApprovalResults.IsAnyChargeCodeExceededLimit Then
                    ...
                    For I = 0 To strAppMessage.Length - 1
                        If oApprovalResults.BudgetExceededLimit(I) Then
                            strAppMessage(I) = Notifiers.NotifyApprover(m_oApprovalDetails.ReqID, m_oApprovalDetails.ApproverID, _
                                m_oApprovalDetails.BU, oApprovalResults.NextBudgetApprover(I), _
...
Public Class Notifiers
    ...
    Public Shared Sub buildNotifyApprover(ByVal strreqID As String, ByVal strAgent As String, ByVal strBU As String, ByVal strAppUserid As String, ByVal strHldStatus As String, Optional ByVal IsLineApproval As Boolean = False, Optional ByVal LineNBR As Integer = 0)
        ...
        strhref = ConfigurationSettings.AppSettings("WebAppName") & "approveorder.aspx?fer=" & streOrdnum & "&op=" & streApper & "&xyz=" & streBU & "&pyt=" & streAppTyp & "&HOME=N"
        ...
        If strHldStatus = "B" Then
            StrSubject = "SDiExchange - Order Number " & strreqID & " needs budget approval"
