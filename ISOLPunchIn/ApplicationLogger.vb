...
#End Region
    ...
    Private Sub AppendLog(ByVal msg As String, ByVal msgLevel As System.Diagnostics.TraceLevel)
        ...
        If bIsWriteLog Then
            ...
            If Not (Directory.Exists(Path:=m_logPath)) Then
                Try
                    Directory.CreateDirectory(Path:=m_logPath)
                Catch ex As Exception
                    ' ignore since next step will throw exception if log folder/path does not exist
                End Try
            End If
