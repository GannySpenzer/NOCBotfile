...
Public Class orderStatusCheckerI0469
    ...
    Private m_deviceDeliveredDocLinkURL As String = "http://www.SDiExchange.com/Trucking/shipmentBOL.aspx?bu={0}&ord={1}"
...
#End Region
    ...
    Private Sub sendEmailNotification(ByVal order As orderHdr, _
        ...
        msgBody &= "<center><span >SDiExchange&reg; - Order Status</span></center>"
        msgBody &= "&nbsp;" & vbCrLf
        ...
        msgOrderDetail &= "&nbsp;<BR>"
        msgOrderDetail &= "Your SDiExchange.com order number " & order.OrderNo & " has been processed and delivered to your location.<br>"
        msgOrderDetail &= "&nbsp;<BR>"
        msgOrderDetail &= "<table id='tab2' cellSpacing='3' cellPadding='1' width='100%' border='0'>"
        msgOrderDetail &= " <tr valign='top'>"
        msgOrderDetail &= "   <td width='120'>Location</td>"
