    ...
    class Logger
    {
        ...
        public void SendEmailAlert(string sLastErrorMessage)
        {
            try
            {
                ...
                string cErrMsg = testOrProd + "Utility WMInventoryOnHand had a critical error";
                string strBodyhead = "";
                string strbodydetl = "";
                string strBody = "";
                ...
                try
                {
                    SDIEmailService.EmailUtilityServices("Mail", "SDIExchADMIN@sdi.com", "webdev@sdi.com; Donna.Ciampoli@sdi.com; scott.doyle@sdi.com; avacorp@sdi.com", testOrProd + "Error from WMInventoryOnHand Utility", "", "", strBody, "SDIERRMAIL", MailAttachmentName, MailAttachmentbytes.ToArray());
                }
                catch (Exception ex1)
                {
                }
