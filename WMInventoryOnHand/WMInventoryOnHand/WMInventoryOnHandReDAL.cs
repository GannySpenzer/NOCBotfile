...
namespace WMInventoryOnHand
{
    class WMInventoryOnHandReDAL
    {
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable getWMInventoryOnHandData(Logger m_oLogger)
        {
            ...
            try
            {
                ...
                //m_oLogger.LogMessage("getWMInventoryOnHandData", "PeopleSoft connection string : " + OracleConString);
                //m_oLogger.LogMessage("getWMInventoryOnHandData", "Query To get the PO SAP Request date : " + strSQLstring);
                //dtResponse = oleDBExecuteReader(strSQLstring);
                //m_oLogger.LogMessage("getWMInventoryOnHandData", "Number of rows Seleted " + dtResponse.Rows.Count);
            }
            catch (Exception ex)
            {
                //m_oLogger.LogMessage("getWMInventoryOnHandData", "Error trying to get the PO SAP Request data.", ex);
        ...
        /// </summary>
        /// <returns></returns>
        public int UpdateWMInventoryOnHandData(Logger m_oLogger, string ProcFlag)
        {
            ...
            try
            {
                ...
                //m_oLogger.LogMessage("UpdateWMInventoryOnHandData", "PeopleSoft connection string : " + OracleConString);
                //m_oLogger.LogMessage("UpdateWMInventoryOnHandData", "Query To Update the PO SAP Request date : " + strSQLstring);

                //rowsAffected = OleDBExecuteNonQuery(strSQLstring);

                //m_oLogger.LogMessage("UpdateWMInventoryOnHandData", "Number of rows updated : " + rowsAffected);

            }
            catch (Exception ex)
            {
                //m_oLogger.LogMessage("UpdateWMInventoryOnHandData", "Error trying to Update the PO SAP Request data.", ex); throw;
            }
            return rowsAffected;
        }
