    ...
    public class Logger
    {
        ...
        public void SendEmailAlert(string sLastErrorMessage)
        {
            try
            {
                ...
                string cErrMsg = testOrProd + "Utility POOverrideReload had a critical error";
                string strBodyhead = "";
                string strbodydetl = "";
                string strBody = "";
                POOverrideReload.SDiEmailUtilityService.EmailServices SDIEmailService = new POOverrideReload.SDiEmailUtilityService.EmailServices();
                ...
                try
                {
                    SDIEmailService.EmailUtilityServices("Mail", "SDIExchADMIN@sdi.com", "webdev@sdi.com", testOrProd + "Error from POOverrideReload Utility", "", "", strBody, "SDIERRMAIL", MailAttachmentName, MailAttachmentbytes.ToArray());
                }
                catch (Exception ex1)
                {
                }
