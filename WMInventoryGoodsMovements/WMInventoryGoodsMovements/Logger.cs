    ...
    class Logger
    {
        ...
        public void SendEmailAlert(string sLastErrorMessage)
        {
            try
            {
                ...
                string cErrMsg = testOrProd + "Utility WMInventoryGoodsMovements had a critical error";
                string strBodyhead = "";
                string strbodydetl = "";
                string strBody = "";
                sdixaws2016test.EmailServices SDIEmailService = new sdixaws2016test.EmailServices();
                //WMInventoryGoodsMovements.sdixaws2016test.EmailServices SDIEmailService = new WMInventoryGoodsMovements.sdixaws2016test.EmailServices();
                ...
                try
                {
                    SDIEmailService.EmailUtilityServices("Mail", "SDIExchADMIN@sdi.com", "webdev@sdi.com; Donna.Ciampoli@sdi.com; scott.doyle@sdi.com; avacorp@sdi.com", testOrProd + "Error from WMInventoryGoodsMovements Utility", "", "", strBody, "SDIERRMAIL", MailAttachmentName, MailAttachmentbytes.ToArray());
                }
                catch (Exception ex1)
                {
                }
