...
Module SDIVendingAutocrib
    ...
    Private Function buildSDIVendingMachineIN() As Boolean
        ...
        Try
            ...
            cmd.CommandText = "UPDATE SYSADM.PS_ISA_LOCK_TBL Set oprid = 'CRIBTRX' Where isa_application = 'AUTOCRIB'"
    ...
    Public Function getLastTranID(ByVal strBU, ByRef trans) As Integer
