                ...
                if (dtResponse.Rows.Count != 0)
                {
                    List<PostPoOrdersProperties> target = dtResponse.AsEnumerable()
                        .Select(row => new PostPoOrdersProperties
                        {
                            ...
                            ORG_ID = (ReplacePipe((String)(row["ISA_ORGANIZ_ID"]))),
                            DOCUMENT_TYPE_CODE = ReplacePipe((String)(row["DOCUMENT"])),
                            CURRENCY_CODE = ReplacePipe((String)(row["CURRENCY_CODE"])),
                            AGENT_ID = (ReplacePipe((String)(row["ISA_EMPL_NUM"]))),
                            FULL_NAME = ReplacePipe((String)(row["BUYER_NAME"])),
                            VENDOR_ID = (ReplacePipe((String)(row["ISA_VENDOR_NUM"]))),
                            VENDOR_SITE_ID = ReplacePipe(((String)(row["ISA_VNDR_SITE_NUM"])).ToString()),
                            HEADER_SHIP_TO_LOCATION_ID = ReplacePipe(((String)(row["ISA_SHIP_LOCNUM"])).ToString()),
                            HEADER_BILL_TO_LOCATION_ID = ReplacePipe(((String)(row["ISA_BILL_LOCNUM"])).ToString()),
                            ...
                            ITEM_ID = ReplacePipe(((String)(row["CUSTOMER_ITEM_NBR"])).ToString()), //ITEM_FIELD_N15_A
                            ...
                            LINE_SHIP_TO_LOCATION_ID = ReplacePipe(((String)(row["ISA_LN_SHIPTO_NUM"])).ToString()),
                            ...
                            DESTINATION_ORGANIZATION_ID = ReplacePipe(((String)(row["ISA_DEST_ORG_ID"])).ToString()), 
                            SET_OF_BOOKS_ID = "",
                            CHARGE_ACCOUNT_ID = ReplacePipe(((String)(row["ISA_ACCOUNT_NUM"])).ToString()),
                            DISTRIBUTION_NUM = (ReplacePipe((String)(row["ISA_DEST_ORG_ID"]))),
                            ...
                            TRANS_STATUS_DESCRIPTION = ReplacePipe((String)(row["ISA_COMMENTS_1333"])), //row["ISA_COMMENTS_1333"] == DBNull.Value ? null : (string)(row["ISA_COMMENTS_1333"]),
                            TRANSACTION_STATUS = ReplacePipe((string)(row["STATUS_MSG"])),
                            BOM_RESOURCE_ID = ReplacePipe(((String)(row["ISA_BOM_RESOURCE"])).ToString()),
                            TERMS_ID = "",
                            LIST_PRICE_PER_UNIT = "",
