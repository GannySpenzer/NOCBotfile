		...
		com.worklight.wlclient.api.WLNotificationListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Worklight.Xamarin.Android.NotificationListener, Worklight.Xamarin.Android, Version=6.3.0.0, Culture=neutral, PublicKeyToken=null", NotificationListener.class, __md_methods);
	}
	...
	public NotificationListener () throws java.lang.Throwable
	{
		...
		if (getClass () == NotificationListener.class)
			mono.android.TypeManager.Activate ("Worklight.Xamarin.Android.NotificationListener, Worklight.Xamarin.Android, Version=6.3.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
