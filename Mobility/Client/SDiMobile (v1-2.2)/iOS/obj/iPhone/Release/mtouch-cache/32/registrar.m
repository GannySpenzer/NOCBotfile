...
void xamarin_create_classes () {
	...
	__xamarin_class_map [77].handle = objc_getClass ("UILocalNotification");
	__xamarin_class_map [78].handle = objc_getClass ("UITextPosition");
	__xamarin_class_map [79].handle = objc_getClass ("UITextRange");
	__xamarin_class_map [80].handle = objc_getClass ("UICollectionViewCell");
	__xamarin_class_map [81].handle = objc_getClass ("UIRefreshControl");
	...
	__xamarin_class_map [97].handle = objc_getClass ("UIFocusUpdateContext");
	__xamarin_class_map [98].handle = objc_getClass ("UIPress");
	__xamarin_class_map [99].handle = objc_getClass ("UIUserNotificationSettings");
