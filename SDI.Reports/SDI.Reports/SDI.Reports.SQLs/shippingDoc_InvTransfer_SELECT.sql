...
,A.SOURCE_BUS_UNIT
,LOC_INV.STORAGE_AREA
,LOC_INV.STOR_LEVEL_1
,LOC_INV.STOR_LEVEL_2
,LOC_INV.STOR_LEVEL_3
,LOC_INV.STOR_LEVEL_4
,LOC_INV.BUSINESS_UNIT AS DESTINATION_BU
FROM
 PS_ISA_PICKING_CNT B
,PS_ISA_PICKING_INT A
,PS_INV_ITEMS E
,PS_ITEM_MFG M
,PS_DEMAND_INV DEMAND_INV
,PS_DEFAULT_LOC_INV LOC_INV
WHERE
  ...
  AND A.BUSINESS_UNIT = DEMAND_INV.BUSINESS_UNIT
  AND A.DEMAND_SOURCE = DEMAND_INV.DEMAND_SOURCE
  AND A.SOURCE_BUS_UNIT = DEMAND_INV.SOURCE_BUS_UNIT
  AND A.ORDER_NO = DEMAND_INV.ORDER_NO
  AND A.ORDER_INT_LINE_NO = DEMAND_INV.ORDER_INT_LINE_NO
  AND A.SCHED_LINE_NO = DEMAND_INV.SCHED_LINE_NO
  AND A.INV_ITEM_ID = DEMAND_INV.INV_ITEM_ID
  AND A.DEMAND_LINE_NO = DEMAND_INV.DEMAND_LINE_NO
  AND DEMAND_INV.DESTIN_BU = LOC_INV.BUSINESS_UNIT (+)
  AND DEMAND_INV.INV_ITEM_ID = LOC_INV.INV_ITEM_ID (+)
GROUP BY 
 A.ORDER_NO
,A.ORDER_INT_LINE_NO
,A.SCHED_LINE_NO
