...
''' used by the 
''' <see cref="M:vbReport.ReportPageEventArgs1.Write(System.String,vbReport.shippingLblRegPickLineJustification)" />
''' and
''' <see cref="M:vbReport.ReportPageEventArgs1.WriteLine(System.String,vbReport.shippingLblRegPickLineJustification)" />
''' methods.
''' </summary>
Public Enum shippingLblRegPickLineJustification
    Left = 0
    Centered = 1
    Right = 2
    col1 = 3
...
''' </summary>
Public Class shippingLabelRegPickEventArgs
    ...
    Public Sub Write(ByVal Text As String, _
        ByVal Justification As shippingLblRegPickLineJustification)
    ...
    Private Function GetMX(ByVal Text As String, _
        ByVal Justification As shippingLblRegPickLineJustification) As Integer

        Select Case Justification
            Case shippingLblRegPickLineJustification.Left
                GetMX = MarginBounds.Left

            Case shippingLblRegPickLineJustification.Centered
                GetMX = MarginBounds.Left + CInt(MarginBounds.Width / 2 - _
                  Graphics.MeasureString(Text, mFont).Width / 2)

            Case shippingLblRegPickLineJustification.Right
                GetMX = CInt(MarginBounds.Right - Graphics.MeasureString(Text, mFont).Width)

            Case shippingLblRegPickLineJustification.col1
                GetMX = MarginBounds.Left

            Case shippingLblRegPickLineJustification.col2
                GetMX = 135

            Case shippingLblRegPickLineJustification.col3
                GetMX = 275

            Case shippingLblRegPickLineJustification.col4
                GetMX = 375

            Case shippingLblRegPickLineJustification.col5
                GetMX = 550

            Case shippingLblRegPickLineJustification.col6
                GetMX = 680

            Case shippingLblRegPickLineJustification.col7
                GetMX = 770

            Case shippingLblRegPickLineJustification.col8
                GetMX = 815

            Case shippingLblRegPickLineJustification.colLineSched
                GetMX = 12

            Case shippingLblRegPickLineJustification.colProductNumber
                GetMX = 102

            Case shippingLblRegPickLineJustification.colShipDate
                GetMX = 246

            Case shippingLblRegPickLineJustification.colUOM
                GetMX = 345

            Case shippingLblRegPickLineJustification.colDescr
                GetMX = 102

            Case shippingLblRegPickLineJustification.colQtyOrdered
                GetMX = 425

            Case shippingLblRegPickLineJustification.colQtyShipped
                GetMX = 500

            Case shippingLblRegPickLineJustification.colQtyBackorder
                GetMX = 575
