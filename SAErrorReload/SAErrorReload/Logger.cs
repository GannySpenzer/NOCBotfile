    ...
    public class Logger
    {
        ...
        public void SendEmailAlert(string sLastErrorMessage)
        {
            try
            {
                ...
                string cErrMsg = testOrProd + "Utility SAErrorReload had a critical error";
                string strBodyhead = "";
                string strbodydetl = "";
                string strBody = "";
                SAErrorReload.SDiEmailUtilityService.EmailServices SDIEmailService = new SAErrorReload.SDiEmailUtilityService.EmailServices();
                ...
                try
                {
                    SDIEmailService.EmailUtilityServices("Mail", "SDIExchADMIN@sdi.com", "webdev@sdi.com", testOrProd + "Error from SAErrorReload Utility", "", "", strBody, "SDIERRMAIL", MailAttachmentName, MailAttachmentbytes.ToArray());
                }
                catch (Exception ex1)
                {
                }
