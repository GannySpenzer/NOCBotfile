...
Public Class Validator
    ...
    Public Shared Function Validate(ByVal xmlString As String, _
                                    Optional ByVal vendorConfig As punchoutVendorConfig = Nothing, _
                                    Optional ByVal appLogger As ApplicationLogger = Nothing) As Validator
    ...
    Private Shared Sub LogMessage(ByVal appLogger As ApplicationLogger, ByVal msg As String, ByVal level As System.Diagnostics.TraceLevel)
