Module RCPT
                ...
                If dr.HasRows Then
                    ...
                    While dr.Read
                        ...
                        Else
                            ...
                            Try
                                bClearErrMsg = CBool(My.Settings("RCPT_ClearErrMsgOnSuccess"))
                            Catch ex As Exception
                            End Try
    ...
    Private Function GetDescriptiveErrorMessage(ByVal oraCN As OleDb.OleDbConnection, _
        ...
        If (sRawMsg.Length > 0) Then
            ...
            Try
                sErrCodePattern = CStr(My.Settings("RCPT_CanParseErrMsgSignature")).Trim
            Catch ex As Exception
            End Try
            ...
            Try
                sErrIdPattern = CStr(My.Settings("RCPT_ErrMsgId")).Trim
            Catch ex As Exception
            End Try
            ...
            If (sErrId.Length > 0) Then
                ...
                sr = New System.IO.StreamReader(CStr(My.Settings("RCPT_GetErrMsgDesc")))
                sql = sr.ReadToEnd
                sr.Dispose()
                sr = Nothing
