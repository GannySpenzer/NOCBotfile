Module INVADJ
    ...
    Sub Main()
        ...
        Const processCode As String = "INVADJ"
        ...
        Try
            s1 = My.Settings(propertyName:="INVADJ_GetBatchSize")
        Catch ex As Exception
            s1 = "0"
        End Try
        If CInt(s1) > 0 Then
        ...
        End If
        Try
            s1 = My.Settings(propertyName:="INVADJ_MaxReq")
        Catch ex As Exception
            s1 = "0"
        End Try
        If CInt(s1) > 0 Then
        ...
        Dim sql As String = ""
        Dim oBatch As INVADJ_batch = Nothing
        ...
        If (oraCN1.State = ConnectionState.Open) Then
            ...
            oBatch = New INVADJ_batch

            sr = New System.IO.StreamReader(CStr(My.Settings("INVADJ_SelectToSend")))
            s = sr.ReadToEnd
            sr.Dispose()
            sr = Nothing
            ...
            Catch ex As Exception
                oBatch.ex = ex
                logger.WriteErrorLog("errorred retrieving inventory adjustment to process from table.")
                Try
                    dr.Close()
            ...
            If Not (dr Is Nothing) Then
                If dr.HasRows Then
                    ...
                    Dim sUpdateKeyColumns As String = CStr(My.Settings("INVADJ_UpdateKeyColumns"))
                    ...
                    While dr.Read
                        ...
                        sr = New System.IO.StreamReader(CStr(My.Settings("INVADJ_HTTP_SOAP_Batch_Item")))
                        s = sr.ReadToEnd
                        sr.Dispose()
                        sr = Nothing
                        ...
                        sr = New System.IO.StreamReader(CStr(My.Settings("INVADJ_HTTP_SOAP_Batch")))
                        s = sr.ReadToEnd
                        sr.Dispose()
                        sr = Nothing
                        ...
                        logger.WriteVerboseLog("loaded INV ADJ HTTP SOAP request XML : " & CStr(My.Settings("INVADJ_HTTP_SOAP_Batch")))
                        ...
                        '// update our table - PS_ISA_MB_ADJ
                        ...
                        sr = New System.IO.StreamReader(CStr(My.Settings("INVADJ_UpdateInputTable")))
                        s = sr.ReadToEnd
                        sr.Dispose()
                        sr = Nothing
                        ...
                        Else
                            ...
                            Catch ex As Exception
                                'oBatch.ex = ex
                                logger.WriteErrorLog("errorred updating inventory adjustment record.")
                            End Try
                ...
                Else        ' If dr.HasRows Then
                    logger.WriteInformationLog("no inventory adjustment to process.")
                End If
