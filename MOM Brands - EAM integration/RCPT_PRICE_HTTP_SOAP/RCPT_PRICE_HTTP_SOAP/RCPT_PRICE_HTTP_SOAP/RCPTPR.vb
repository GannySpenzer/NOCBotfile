Module RCPTPR
    ...
    Sub Main()
        ...
        Const processCode As String = "RCPTPR"
        ...
        Try
            s1 = My.Settings(propertyName:="RCPTPR_GetBatchSize")
        Catch ex As Exception
            s1 = "0"
        End Try
        If CInt(s1) > 0 Then
        ...
        End If
        Try
            s1 = My.Settings(propertyName:="RCPTPR_MaxReq")
        Catch ex As Exception
            s1 = "0"
        End Try
        If CInt(s1) > 0 Then
        ...
        Dim sql As String = ""
        Dim oBatch As RCPTPR_batch = Nothing
        ...
        If (oraCN1.State = ConnectionState.Open) Then
            ...
            oBatch = New RCPTPR_batch

            sr = New System.IO.StreamReader(CStr(My.Settings("RCPTPR_SelectToSend")))
            s = sr.ReadToEnd
            sr.Dispose()
            sr = Nothing
            ...
            If Not (dr Is Nothing) Then
                If dr.HasRows Then
                    ...
                    Dim sBusinessUnitIN As String = ""
                    Dim sStorageArea As String = ""
                    Dim sStoreLevel1 As String = ""
                    Dim sStoreLevel2 As String = ""
                    Dim sStoreLevel3 As String = ""
                    Dim sStoreLevel4 As String = ""
                    ...
                    Dim sUpdateKeyColumns As String = CStr(My.Settings("RCPTPR_UpdateKeyColumns"))
                    ...
                    While dr.Read
                        ...
                        sPlant = ""
                        Try
                            sPlant = CStr(dr("PLANT")).Trim.ToUpper
                        Catch ex As Exception
                        End Try
                        ...
                        sInvItemId = ""
                        Try
                            sInvItemId = CStr(dr("INV_ITEM_ID")).Trim
                        Catch ex As Exception
                        End Try
                        If (sInvItemId Is Nothing) Then
                            sInvItemId = ""
                        End If
                        ...
                        sBusinessUnitIN = ""
                        Try
                            sBusinessUnitIN = CStr(dr("BUSINESS_UNIT_IN")).Trim
                        Catch ex As Exception
                        End Try
                        If (sBusinessUnitIN Is Nothing) Then
                            sBusinessUnitIN = ""
                        End If

                        sStorageArea = ""
                        Try
                            sStorageArea = CStr(dr("STORAGE_AREA")).Trim
                        Catch ex As Exception
                        End Try
                        If (sStorageArea Is Nothing) Then
                            sStorageArea = ""
                        End If

                        sStoreLevel1 = ""
                        Try
                            sStoreLevel1 = CStr(dr("STOR_LEVEL_1")).Trim
                        Catch ex As Exception
                        End Try
                        If (sStoreLevel1 Is Nothing) Then
                            sStoreLevel1 = ""
                        End If

                        sStoreLevel2 = ""
                        Try
                            sStoreLevel2 = CStr(dr("STOR_LEVEL_2")).Trim
                        Catch ex As Exception
                        End Try
                        If (sStoreLevel2 Is Nothing) Then
                            sStoreLevel2 = ""
                        End If

                        sStoreLevel3 = ""
                        Try
                            sStoreLevel3 = CStr(dr("STOR_LEVEL_3")).Trim
                        Catch ex As Exception
                        End Try
                        If (sStoreLevel3 Is Nothing) Then
                            sStoreLevel3 = ""
                        End If

                        sStoreLevel4 = ""
                        Try
                            sStoreLevel4 = CStr(dr("STOR_LEVEL_4")).Trim
                        Catch ex As Exception
                        End Try
                        If (sStoreLevel4 Is Nothing) Then
                            sStoreLevel4 = ""
                        End If

                        sEmpId = ""
                        Try
                            sEmpId = CStr(dr("ISA_EMPLID_30")).Trim
                        Catch ex As Exception
                        End Try
                        If (sEmpId Is Nothing) Then
                            sEmpId = ""
                        End If
                        ...
                        sKey = sPlant & "." & sInvItemId & "." & sReceiverId & "." & nRecId.ToString.PadLeft(4, "0"c)
                        ...
                        sr = New System.IO.StreamReader(CStr(My.Settings("RCPTPR_HTTP_SOAP_Batch_Item")))
                        s = sr.ReadToEnd
                        sr.Dispose()
                        sr = Nothing
                        ...
                        sb = New System.Text.StringBuilder
                        sb.AppendFormat(s, sReceiverId, sPoId, sReqId, sVendorId, sPlant, sInvItemId, sBin, nQty.ToString, nPrice.ToString, sPlant, sSerialId, sWorkOrderNo, sEmpId)
                        iList &= sb.ToString
                        sb = Nothing
                        ...
                        sr = New System.IO.StreamReader(CStr(My.Settings("RCPTPR_HTTP_SOAP_Batch")))
                        s = sr.ReadToEnd
                        sr.Dispose()
                        sr = Nothing
                        ...
                        'logger.WriteVerboseLog("loaded RCPT PRICE HTTP SOAP request XML : " & s)
                        logger.WriteVerboseLog("loaded RCPTPR HTTP SOAP request XML : " & CStr(My.Settings("RCPTPR_HTTP_SOAP_Batch")))
                        ...
                        Else
                            ...
                            Try
                                bClearErrMsg = CBool(My.Settings("RCPTPR_ClearErrMsgOnSuccess"))
                            Catch ex As Exception
                            End Try
                        ...
                        '// update our table - PS_ISA_MB_REPRICE
                        ...
                        sr = New System.IO.StreamReader(CStr(My.Settings("RCPTPR_UpdateInputTable")))
                        s = sr.ReadToEnd
                        sr.Dispose()
                        sr = Nothing
                        ...
                        Else
                            ...
                            Catch ex As Exception
                                'oBatch.ex = ex
                                logger.WriteErrorLog("errorred updating receipt price record that was processed.")
                            End Try
    ...
    Private Function GetDescriptiveErrorMessage(ByVal oraCN As OleDb.OleDbConnection, _
        ...
        If (sRawMsg.Length > 0) Then
            ...
            Try
                sErrCodePattern = CStr(My.Settings("RCPTPR_CanParseErrMsgSignature")).Trim
            Catch ex As Exception
            End Try
            ...
            Try
                sErrIdPattern = CStr(My.Settings("RCPTPR_ErrMsgId")).Trim
            Catch ex As Exception
            End Try
            ...
            If (sErrId.Length > 0) Then
                ...
                sr = New System.IO.StreamReader(CStr(My.Settings("RCPTPR_GetErrMsgDesc")))
                sql = sr.ReadToEnd
                sr.Dispose()
                sr = Nothing
