    ...
    public class ReqReviewReloadDAL
    {
        ...
        public void CreateTable(Logger m_oLogger)
        {
            try
            {
                ...
                strSQLstring += "D.ISA_SELL_PRICE as Sell_Price,\n";
                ...
                strSQLstring += "D.ADD_DTTM AS Req_Line_Add_Date,\n";
                ...
                strSQLstring += "     SYSADM8.PSXLATITEM D17X,\n";
                strSQLstring += "     SYSADM8.PS_REQ_LN_DISTRIB E,\n";
                strSQLstring += "     SYSADM8.PS_DEPT_TBL G,\n";
                strSQLstring += "     SYSADM8.PS_PV_REQ_AW H,\n";
                strSQLstring += "     SYSADM8.PS_EOAW_STEPINST I,\n";
                ...
                strSQLstring += "and D.ORDER_NO(+) = C.REQ_ID\n";
                strSQLstring += "AND D.ISA_INTFC_LN(+) = C.LINE_NBR\n";
                strSQLstring += "AND B.CURR_STATUS IN('D','H','O','P')\n";
                strSQLstring += "AND B.BUSINESS_UNIT = C.BUSINESS_UNIT\n";
                strSQLstring += "and D17X.FIELDNAME = 'ISA_LINE_STATUS'\n";
                strSQLstring += "AND D17X.FIELDVALUE = D.ISA_LINE_STATUS\n";
                strSQLstring += "AND D17X.EFF_STATUS = 'A'\n";
                strSQLstring += "and D17X.EFFDT = (SELECT MAX(EFFDT)\n";
                strSQLstring += "                            FROM SYSADM8.PSXLATITEM TB\n";
                strSQLstring += "                            WHERE TB.FIELDNAME = D17X.FIELDNAME\n";
                strSQLstring += "                            AND TB.FIELDVALUE = D17X.FIELDVALUE\n";
                strSQLstring += "                            AND TB.EFF_STATUS = 'A'\n";
                strSQLstring += "                            AND TB.EFFDT <= D.ISA_REQUIRED_BY_DT)\n";
                ...
                strSQLstring += "AND E.BUSINESS_UNIT = H.BUSINESS_UNIT\n";
                strSQLstring += "AND E.REQ_ID = H.REQ_ID\n";
                strSQLstring += "AND E.LINE_NBR = H.LINE_NBR\n";
                strSQLstring += "AND H.EOAWPRCS_ID = 'Requisition'\n";
                strSQLstring += "AND H.RECNAME = 'PV_REQLIN_AW_VW'\n";
                strSQLstring += "AND H.EOAWTHREAD_ID = I.EOAWTHREAD_ID\n";
                strSQLstring += "AND H.EOAWPRCS_ID = I.EOAWPRCS_ID\n";
                strSQLstring += "AND I.EFFDT = (SELECT MAX(I_ED.EFFDT)\n";
                strSQLstring += "                            FROM SYSADM8.PS_EOAW_STEPINST I_ED\n";
                strSQLstring += "                            WHERE I.EOAWTHREAD_ID = I_ED.EOAWTHREAD_ID\n";
                strSQLstring += "                            AND I.EOAWSTEP_INSTANCE = I_ED.EOAWSTEP_INSTANCE\n";
                strSQLstring += "                            AND I.EOAWPRCS_ID = I_ED.EOAWPRCS_ID\n";
                strSQLstring += "                            AND I.EOAWDEFN_ID = I_ED.EOAWDEFN_ID\n";
                strSQLstring += "                            AND I_ED.EFFDT <= SYSDATE)\n";
                strSQLstring += "AND I.EOAWSTEP_INSTANCE = J.EOAWSTEP_INSTANCE\n";
                strSQLstring += "AND J.EOAWSTEP_STATUS IN('D','P','H','G')\n";
                strSQLstring += "AND J.EOAWORIG_OPRID <> 'EXTAPPRV'\n";
                strSQLstring += "AND J.EOAWDTTM_MODIFIED = (select max(MX.EOAWDTTM_MODIFIED)  from SYSADM8.PS_EOAW_USERINST MX where MX.EOAWSTEP_INSTANCE = I.EOAWSTEP_INSTANCE )\n";
                strSQLstring += "And d.isa_line_status not in ('RFX', 'RFC', 'RFY', 'RFZ', 'QTS', 'QTW', 'QTC', 'CNC', 'QTR')\n";
