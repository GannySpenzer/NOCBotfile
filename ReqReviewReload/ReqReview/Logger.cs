    ...
    public class Logger
    {
        ...
        public void SendEmailAlert(string sLastErrorMessage)
        {
            try
            {
                ...
                string cErrMsg = testOrProd + "Utility ReqReviewReload had a critical error";
                string strBodyhead = "";
                string strbodydetl = "";
                string strBody = "";
                ReqReview.SDiEmailUtilityService.EmailServices SDIEmailService = new ReqReview.SDiEmailUtilityService.EmailServices();
                ...
                try
                {
                    SDIEmailService.EmailUtilityServices("Mail", "SDIExchADMIN@sdi.com", "webdev@sdi.com", testOrProd + "Error from ReqReviewReload Utility", "", "", strBody, "SDIERRMAIL", MailAttachmentName, MailAttachmentbytes.ToArray());
                }
                catch (Exception ex1)
                {
                }
