...
Public Class runInformation
    ...
    Private m_ResponseEmailRecipients As String
    ...
    Public Property ResponseEmailRecipients() As String
        Get
            If m_ResponseEmailRecipients Is Nothing Then
                ResponseEmailRecipients = ""
            Else
                ResponseEmailRecipients = m_ResponseEmailRecipients
            End If

        End Get
        Set(value As String)
            m_ResponseEmailRecipients = value
        End Set
    End Property
