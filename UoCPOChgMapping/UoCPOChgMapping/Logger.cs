    ...
    class Logger
    {
        ...
        public void SendEmailAlert(string sLastErrorMessage)
        {
            try
            {
                ...
                string cErrMsg = testOrProd + "Utility UoCPOChgMapping had a critical error";
                string strBodyhead = "";
                string strbodydetl = "";
                string strBody = "";
                
                UoCPOChgMapping.SDiEmailUtilityService.EmailServices SDIEmailService = new UoCPOChgMapping.SDiEmailUtilityService.EmailServices();
                ...
                try
                {
                    SDIEmailService.EmailUtilityServices("Mail", "SDIExchADMIN@sdi.com", "webdev@sdi.com; Donna.Ciampoli@sdi.com; scott.doyle@sdi.com", testOrProd + "Error from UoCPOChgMapping Utility", "", "", strBody, "SDIERRMAIL", MailAttachmentName, MailAttachmentbytes.ToArray());
                }
                catch (Exception ex1)
                {
                }
