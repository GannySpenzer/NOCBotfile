...
Public Class SQLDBData
    ...
    Public Shared Function GetSQLAdapter(ByVal p_strQuery As String) As DataSet
        ...
        Catch objException As SqlException
            ...
            connection.close()
            sendErrorEmail(objException.ToString, "NO", ("URL"), p_strQuery)
    ...
    Public Shared Function getRepDBConnectString(ByVal strConnectString, ByVal strCatalogID) As String
        ...
        strdb = WebPartnerFunctions.WebPSharedFunc.getCPlusProddbOverride(DBfile, currentApp.Session("CplusDB"))
    ...
    Public Shared ReadOnly Property DbSQLUrl() As String
        ...
        Get
            Return System.Configuration.ConfigurationSettings.AppSettings("SQLDBconString")
        End Get
    End Property
    ...
    Public Shared ReadOnly Property DbSQLUrl1() As String
        ...
        Get
            Return System.Configuration.ConfigurationSettings.AppSettings("SQLDBconString1")
        End Get
    End Property
    ...
    Public Shared ReadOnly Property DbSQLRepUrl() As String
        ...
        Get
            Return System.Configuration.ConfigurationSettings.AppSettings("SQLDBReplicateConString")
        End Get
    End Property
    ...
    Public Shared ReadOnly Property DbSQLRepUrl1() As String
        ...
        Get
            Return System.Configuration.ConfigurationSettings.AppSettings("SQLDBReplicateConString1")
        End Get
    End Property
