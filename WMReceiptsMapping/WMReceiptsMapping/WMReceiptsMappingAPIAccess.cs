    ...
    class WMReceiptsMappingAPIAccess
    {
        ...
        public string postWMReceiptMappingData(Logger m_oLogger)
        {
            ...
            try
            {
                ...
                if (dtResponse.Rows.Count != 0)
                {
                    ...
                    using (var client = new WebClient())
                    {
                        ...
                        m_oLogger.LogMessage("postWMReceiptMappingData", "POST WMReceipt Mapping Data to PMC starts here");
                        ...
                        m_oLogger.LogMessage("postWMReceiptMappingData", "POST WMReceiptMapping data to PMC server status " + strResponse);
            ...
            catch (WebException ex)
            {
                ...
                m_oLogger.LogMessageWeb("postWMReceiptMappingData", "Error trying to POST data to PMC server.", responseErrorText); //ex
            }
            return strResponse;
        }
