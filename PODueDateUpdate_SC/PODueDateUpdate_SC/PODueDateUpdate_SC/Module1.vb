...
Module Module1
    ...
    Sub Main()
        ...
        Dim bolError As Boolean = PODueDateUpdate()
    ...
    Private Function PODueDateUpdate() As Boolean
        Try

            Dim strSQLstrings As String = "select * from ps_isa_poduedtmon where BUSINESS_UNIT= 'WAL00' and NOTIFY_DTTM is null and TRUNC(ADD_DTTM) = TRUNC(SYSDATE)
