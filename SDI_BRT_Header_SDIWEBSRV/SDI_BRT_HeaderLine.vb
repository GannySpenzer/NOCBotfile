                ...
                Try
                    ...
                    Else
                        ...
                        lineSql = "SELECT SYSADM8.PS_APXVCHRLINE_STG.PO_ID, SYSADM8.PS_APXVCHRLINE_STG.DESCR, SYSADM8.PS_APXVCHRLINE_STG.INV_ITEM_ID, SYSADM8.PS_APXVCHRLINE_STG.QTY_VCHR, " & _
                            ...
                            "SYSADM8.PS_LOCATION_TBL.ADDRESS1, SYSADM8.PS_LOCATION_TBL.ADDRESS2, SYSADM8.PS_LOCATION_TBL.ADDRESS3,  " & _
                            "SYSADM8.PS_LOCATION_TBL.CITY, SYSADM8.PS_LOCATION_TBL.STATE, SYSADM8.PS_LOCATION_TBL.POSTAL, SYSADM8.PS_LOCATION_TBL.COUNTRY, SYSADM8.PS_APXVCHRDIST_STG.ACCOUNT " & _
                            "FROM SYSADM8.PS_APXVCHRLINE_STG " & _
                            "LEFT JOIN SYSADM8.PS_PO_LINE_SHIP ON SYSADM8.PS_APXVCHRLINE_STG.BUSINESS_UNIT_PO = SYSADM8.PS_PO_LINE_SHIP.BUSINESS_UNIT AND SYSADM8.PS_APXVCHRLINE_STG.PO_ID = SYSADM8.PS_PO_LINE_SHIP.PO_ID AND SYSADM8.PS_APXVCHRLINE_STG.LINE_NBR = SYSADM8.PS_PO_LINE_SHIP.LINE_NBR " & _
                            ...
                            "LEFT JOIN SYSADM8.PS_LOCATION_TBL ON SYSADM8.PS_PO_LINE_SHIP.SHIPTO_ID = SYSADM8.PS_LOCATION_TBL.LOCATION " & _
                            ...
                            " AND ((SYSADM8.PS_LOCATION_TBL.EFFDT = (SELECT MAX(A.EFFDT) FROM SYSADM8.PS_LOCATION_TBL A WHERE SYSADM8.PS_LOCATION_TBL.LOCATION = A.LOCATION) " & _
                            "AND SYSADM8.PS_LOCATION_TBL.EFFDT <= SYSDATE) OR SYSADM8.PS_LOCATION_TBL.EFFDT IS NULL)" & _
                            " ORDER BY 11"
